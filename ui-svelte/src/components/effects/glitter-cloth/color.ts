// Color helpers for the GlitterCloth shader. Adapted from the Motion Core
// registry component (https://motion-core.dev/docs/glitter-cloth, MIT) so we
// can ship the effect without depending on the registry CLI tooling.
